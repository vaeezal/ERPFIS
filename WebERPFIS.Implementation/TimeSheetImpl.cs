...
{
    public class TimeSheetImpl : ITimeSheet
    {
        ...
        public IQueryable<TimeSheetMasterView> ShowTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            var IQueryableERPFIS = (from timesheetmaster in _context.TimeSheetMaster
            ...
            {
                IQueryableERPFIS = IQueryableERPFIS.Where(m => m.FromDate == Search);
            }
        ...
        public IQueryable<TimeSheetMasterView> ShowAllTimeSheet(string sortColumn, string sortColumnDir, string Search, int UserID)
        {
            ...
            if (!string.IsNullOrEmpty(Search))
            {
                IQueryableERPFIS = IQueryableERPFIS.Where(m => m.FromDate == Search || m.Username == Search);
            }
